...
class WsbaoTransOutPage(Page):
    ...
    '''#####页面对象#####'''
    '''首页'''
    firstPage_wsbaotransout_link = PageElement(xpath="//*[@data-reactid='.0.0.0.1.1.0.1.0.1.2.0.1.0.1']",
                                        describe="余利宝转出")


    '''录入页'''
    secondPage_wsbaotransout_ant = PageElement(xpath="//*[@data-reactid='.0.0.0.1.1.0.1.0.1.0.0.$/=11.$/=10.$/=11.$/=10']"
                                         , describe="余额")
    secondPage_wsbaotransout_input = PageElement(xpath="//*[@data-reactid='.0.0.0.1.1.0.1.0.1.0.0.$/=11.$/=11.$/=11.0.$/=10']"
                                         , describe="转出金额")
    secondPage_wsbaotransout_output = PageElement(xpath="//*[@data-reactid='.0.0.0.1.1.0.1.0.1.0.0.$/=11.$/=12.$/=11.0']", describe="大写金额")
    secondPage_next_button = PageElement(xpath="//input[@data-reactid='.0.0.0.1.1.0.1.0.1.0.0.$/=12.$/=10']", describe="下一步")
